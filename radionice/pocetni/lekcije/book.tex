...
\tableofcontents}
\newpage
\fakesection{001: Uvod u radionice japanskog jezika}
	...
	\end{hyou}
\newpage
\fakesection{002: Glasovni sustav japanskog - hiragana}
...
\newpage
\fakesection{003: Imenice i pokazne zamjenice}
...
\newpage
\fakesection{004: Osobne zamjenice i oslovljavanje ljudi; čestice と i や}
...
\newpage
\fakesection{006: Pridjevi kao imenski predikat}
...
\newpage
\fakesection{007: Opisni oblik pridjeva}
...
\newpage
\fakesection{013: Priložne oznake mjesta}
	...
	\fukudai{Čestica へ kao smjer}
	
	Čestica へ označava smjer nekog kretanja ili neke radnje. Sam cilj koji je naveden nije toliko bitan u usporedbi s putem ili smjerom, za razliku od čestice に kod koje je cilj puno bitniji. Čestica へ također naglašava udaljenost ili napor koji je potrebno uložiti za dolazak do cilja:
	
	\begin{reibun}
		\rei{東京に行く。}{Idem u Tokio. (Moje putovanje završava u Tokiju, sigurno želim ići tamo.)}
		\rei{東京へ行く。}{Idem prema Tokiu. (Možda je moj cilj tamo, a možda nije, ono što je bitno je da idem u tom smjeru, a ne nekom drugom.)}
	\end{reibun}
	
	Čestica へ se može koristiti i za destinaciju:
	\begin{reibun}
		\rei{日本へようこそ。}{Dobrodošli u Japan.}
	\end{reibun}
	
	Takvi su izrazi u pravilu vrlo pristojni i izražavaju zahvalnost putniku što je prevalio put do tog mjesta.
	
	Čestica へ se također koristi za navođenje primatelja pisama:
	\begin{reibun}
		\rei{たけし君へ。}{Za Takešija.}
	\end{reibun}
...
\newpage
\fakesection{014: Priložne oznake vremena}
...
\fakesection{016: Količina II}
	...
	\end{mondai}
\newpage
\fakesection{017: Pitanja i završne čestice}
...
\fakesection{019: て oblik}
	...
	\end{mondai}
\newpage
\fakesection{020: Upotrebe い oblika I}
	...
	\end{mondai}
\newpage
\fakesection{021: Upotrebe て oblika I}
	...
	\end{mondai}
\newpage
\fakesection{022: Složene rečenice}
