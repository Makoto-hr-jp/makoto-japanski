...
\begin{document}
	...
	U japanskom jeziku, kada govorimo o sebi, najčešće koristimo neku osobnu zamjenicu poput わたし, a kad govorimo o drugim osobama tada češće koristimo njihovo ime koje na kraju ima prilijepljen nastavak (npr.-さん,ともきさん) koji određuje naš odnos prema toj osobi.
	...
	\footnotetext[2]{きみ ponekad koriste muške osobe kada se obraćaju svojoj jako bliskoj prijateljici, a おまえ mogu koristiti muške i ženske osobe kada se obraćaju bliskim muškim prijateljima.}
	...
	\begin{tabular}{|l|l|l|}
		\hline
		きみ\footnotemark[2]&ti&kolokvijalni ženski\\\hline
		あんた&ti&kolokvijalni muški\\\hline
		おまえ\footnotemark[2]&ti&kolokvijalni\\\hline
	\end{tabular}	
