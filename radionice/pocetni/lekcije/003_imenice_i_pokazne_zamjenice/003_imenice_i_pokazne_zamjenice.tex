...
\vspace{10pt}
	...
	Čestica の može se koristiti u razne svrhe. Kao posvojnu zamjenicu koristimo je za opisivanje imenica i ukazivanje na pripadnost.
	...
	\begin{reibun}
		\rei{たなか　さん　の　ほん　の　おもさ。}{Debljina Tanakine knjige.}
		\rei{この　がっこう　の　いす}{Ova školska stolica.}
		\rei{この　いす　の　たかさ}{Visina ove stolice.}
	\end{reibun}
	...
	\begin{mondai}{Lv. 2}
		\item にわ　の　にわとり　の　とり
		\item この　はな　さん　の　りんご　の　き
		\item あの　おか　の　いえ　の　おばあさん　の　いぬ
	\end{mondai}
