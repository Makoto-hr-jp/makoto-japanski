...
\begin{document}
	...
	\begin{reibun}
		...
		\rei{昨日、山田は富士山をお登りしました。}{Jučer se Yamada popeo na Fuji.}
	\end{reibun}	
	...
	\begin{reibun}
		...
		\rei{昨日、山田様富士山を登りになりました。}{Jučer se Yamada popeo na Fuji.}
	\end{reibun}

	Korištenje pasivnog oblika glagola u aktivnom smislu je također vrsta 尊敬語-a.
	
	\begin{reibun}
		\rei{昨日、山田様富士山を登られました。}{Jučer se Yamada popeo na Fuji.}
	\end{reibun}
