...
\begin{document}
	...
	\rei{私\underline{の}大きいです。}{Moja je velika.(「の」はケーキの省略)}
	\rei{ケーキを作る\underline{の}が好きです。}{Volim raditi torte.(名詞化)}
	\rei{ケーキが大きい\underline{の}\footnotemark[1]はいいことです。}{Dobro je kad je torta velika.}
	\rei{彼女がここへ来た\underline{の}は４日です。８日ではありません。}{Ona je ovamo došla četvrtog. Ne osmog.}
	\rei{彼女は４日にここへ来た}{Ona je četvrtog došla ovamo.}
	\end{reibun}
	...
	\textit{Zbog odrona stijene JR je prestao biti u pogonu.Zbog toga,ljudi su jako zbunjeni na području glavnog grada.}
	
	\begin{reibun}
	\rei{崖崩れでJRが不通となった\underline{ため}、首都圏の足が大きく混乱した。}{}
	\end{reibun}

	\textit{Ljudi su jako zbunjeni na području glavnog grada jer je JR prestao biti u pogonu zbog odrona stijene.}
	...
	\begin{reibun}
	\rei{失敗した\underline{せいで}、みんなに迷惑をかけました。}{Sve sam zabrinuo zbog toga što nisam uspio.}
	\rei{全てはあなたの\underline{せい}だよ！}{Sve si ti kriv! (ためとの比較)}
	\end{reibun}
	...
	\rei{その\underline{まま}に\footnotemark[3]してください。}{Učini to tako molim te.}
	\rei{熱い\underline{まま}、お皿に盛ります}{servirati tanjur dok je vrući}
	\rei{長い\underline{まま}では食べにくいので短く切ります。}{Dok je dugačko je teško za jesti pa ću odrezati na kraće.}
	\end{reibun}
	...
	\footnotetext[3]{「なる・する」は大抵「に」を使う}
	...
	\begin{reibun}
	\rei{このコインはお金の\underline{かわり}です。}{Ovaj zlatnik je umjesto novaca.}
...
\textit{Mogu pomoći, ali što ćeš mi dati u zamjenu za to?}
