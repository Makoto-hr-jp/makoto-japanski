...
\begin{document}
	...
	\begin{reibun}[\ten \furigana{終}{お}わる - \textit{završiti}\textasciitilde]
		\rei{パンが食べ終わって学校へ行った。}{Pojeo sam kruh i otišao u školu.}
		\rei{\furigana{徹夜}{てつや}をしてレポートを書き終わった。}{Ostao sam budan cijelu noć i završio s pisanjem izvješća.}
	\end{reibun}
	...
	\begin{reibun}[\ten 出す - \textit{iz\textasciitilde\ / početi \textasciitilde}]
		...
		\reinagai{彼を見た山田くんは「\furigana{逃}{にげ}げましょう」と\furigana{平然}{へいぜん}と言い出しました。}{Vidjevši ga, Jamada je mrtav 'ladan predložio da pobjegnemo.}
	...
	\begin{reibun}[\ten すぎる - \textit{pre\textasciitilde}, pretjerati s \textasciitilde]
		\reinagai{たこ\furigana{焼}{や}きを食べすぎて、タコが\furigana{嫌}{きら}いになりそうだ。}{Prejeo sam se takoyakija, mislim da ću zamrziti hobotnice.}
	...
	\begin{reibun}[\ten ながら - \textasciitilde\ ći - sadašnji glagolski prilog (p.o. vremena)]
		\reinagai{たけしくんは彼女のことを思いながら、安っぽい詩を書いていました。}{Takeši je, razmišljajući o njoj, pisao jeftinu poeziju.}
