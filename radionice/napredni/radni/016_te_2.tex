...
\begin{document}
	...
	\begin{reibun}[\textasciitilde てまで $\rightarrow$ \textit{toliko da \textasciitilde, s takvom posljedicom da \textasciitilde\footnotemark[3]}]
		...
		\reinagai{\parbox{500pt}{\furigana{渋谷}{しぶや}に１時間も\furigana{並}{なら}んで\furigana{待}{ま}たなければならない人気な\furigana{店}{みせ}がある。私は並んでまでその店に入りたいと思いません。}}{\parbox{500pt}{U Šibuji postoji dućan/kafić/štogod za koji treba čekati u redu čak sat vremena. Ja ne želim ući unutra toliko da bih stao u red.}}
	\end{reibun}
