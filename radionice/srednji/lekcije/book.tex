...
\fakesection{027: Usporedbe I}
	...
	\begin{reibun}
		...
		\rei{武くんは\underline{花子ちゃんより}\furigana{背}{せ}が高い。}{Takeši je viši \underline{od Hanako}.}
	\end{reibun}
...
\fakesection{030: Kauzativ}
	...
	\begin{reibun}
		...
		\rei{彼の振る舞いは私たちを悩ます。}{Njegovo ponašanje nas tjera da se brinemo (o njemu).}
		\rei{彼女を怖がらせるつもりはなかったんだ。}{Nisam je htio prestrašiti.}
	\end{reibun}
...
\newpage
\fakesection{032: Potencijal}\footnotemark[1]
