...
\begin{document}
	...
	\noindent
	Uočimo kako u rečenicama iznad nismo preveli ni とき ni ころ, već smo njihove opise u hrvatskom preveli kao zavisne rečenice koje opisuju vrijeme glavne. Ovo je najbitnija osobina priložnih imenica.
	...
	\begin{reibun}
		...
		\reinagai{先生が　また　来ていない　あいだに　まどから　きょうしつに　はいった。}{Dok učitelj još nije došao, ušao sam u učionicu kroz prozor.}
	\end{reibun}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=200pt]{img/timing}
